...
export const ServerSelectionScreen = ({
  account,
  servers,
  loading,
  starting,
  ...
  <AuthLayout>
    ...
    <p className="subtitle">
      Select the Plex server that hosts your music library.
    </p>
    ...
    <div className="server-list">
      {loading ? (
        ...
        servers.map((server) => {
          const usable = server.url !== null && server.url !== "";
          return (
            <button
    ...
    {error !== null && error !== "" && <p className="server-error">{error}</p>}
    <p className="hint">
    ...
    <button
      ...
      type="button"
      disabled={selected === null || selected === "" || starting}
      onClick={onStart}
    >
      Start listening
    </button>
