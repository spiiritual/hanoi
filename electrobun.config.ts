...
export default {
  ...
  build: {
    ...
    copy: {
      ...
      "src/mainview/auth/ConnectedScreen.css": "views/mainview/auth/ConnectedScreen.css",
      "src/mainview/auth/ServerSelection.css": "views/mainview/auth/ServerSelection.css",
      ...
      "src/mainview/player/PlaybackControls.css": "views/mainview/player/PlaybackControls.css",
      "src/mainview/player/VolumeControls.css": "views/mainview/player/VolumeControls.css",
    },
    mac: {
      bundleCEF: false,
    },
